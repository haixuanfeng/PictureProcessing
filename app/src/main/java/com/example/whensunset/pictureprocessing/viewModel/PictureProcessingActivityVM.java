package com.example.whensunset.pictureprocessing.viewModel;
...
import com.example.whensunset.pictureprocessing.base.viewmodel.ParentBaseVM;
...
import com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureFilterMenuVM;
import com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureFrameMenuVM;
import com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM;
import com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTextMenuVM;
import com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM;
...
import static com.example.whensunset.pictureprocessing.base.BaseSeekBarRecycleViewVM.LEAVE_BSBRV_VM_LISTENER;
import static com.example.whensunset.pictureprocessing.base.uiaction.UIActionManager.CLICK_ACTION;
import static com.example.whensunset.pictureprocessing.base.viewmodel.ItemManagerBaseVM.CLICK_ITEM;
import static com.example.whensunset.pictureprocessing.mete.CutView.CUT_MODEL;
import static com.example.whensunset.pictureprocessing.mete.CutView.INSERT_IMAGE_MODEL;
import static com.example.whensunset.pictureprocessing.mete.CutView.INSERT_TEXT_MODEL;
import static com.example.whensunset.pictureprocessing.mete.CutView.SCALE_MODEL;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureFilterItemVM_mat;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureFrameItemVM_mat;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureParamMenuVM_mat;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureProcessingActivityVM_intent;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureTextItemVM_mat;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureTransformMenuVM_mat;
import static com.example.whensunset.pictureprocessing.staticParam.ObserverMapKey.PictureTransformMenuVM_position;
import static com.example.whensunset.pictureprocessing.staticParam.StaticParam.LOADING_GIF;
import static com.example.whensunset.pictureprocessing.staticParam.StaticParam.SHARE_IMAGE;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM.PARAM_PROGRESS_CHANGE;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM.SELECT_BRIGHTNESS;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM.SELECT_CONTRAST;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM.SELECT_SATURATION;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureParamMenuVM.SELECT_TONAL;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTextMenuVM.TEXT_CHANGE;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.LEAVE_TRANSFORM_LISTENER;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.SELECT_PICTURE_CUT;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.SELECT_PICTURE_HORIZONTAL_FLIP;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.SELECT_PICTURE_ROTATE;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.SELECT_PICTURE_VERTICAL_FLIP;
import static com.example.whensunset.pictureprocessing.viewModel.includeLayoutVM.PictureTransformMenuVM.SELECT_PICTURE_WHITE_BALANCE;
